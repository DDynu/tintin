...
- [x] **Step 1: Create hooks/useAuth.ts**
...
- [x] **Step 2: Create hooks/useChat.ts**
...
- [x] **Step 4: Create Login.tsx and Register.tsx** (similar to spec, using auth hooks)

- [x] **Step 5: Create App.tsx**
...
- [x] **Step 1: Write basic hook tests**
